...
static class WebUI
{
    ...
    [DllImport(DLL, CallingConvention = Cdecl)][return: MarshalAs(UnmanagedType.I1)] public static extern bool webui_set_port(UIntPtr window, UIntPtr port);
    [DllImport(DLL, CallingConvention = Cdecl)] public static extern UIntPtr webui_get_free_port();
